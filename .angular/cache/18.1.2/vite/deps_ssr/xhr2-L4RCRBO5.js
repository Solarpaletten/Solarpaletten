  ...
  "node_modules/xhr2/lib/xhr2.js"(exports, module) {
    (function() {
      ...
      XMLHttpRequestEventTarget = (function() {
        class XMLHttpRequestEventTarget2 {
          ...
          dispatchEvent(event) {
            ...
            if (listener = this["on".concat(eventType)]) {
              listener.call(this, event);
            }
            return void 0;
          }
      ...
      XMLHttpRequest = (function() {
        class XMLHttpRequest2 extends XMLHttpRequestEventTarget {
          ...
          open(method, url2, async, user, password) {
            ...
            if (method in this._restrictedMethods) {
              throw new SecurityError("HTTP method ".concat(method, " is not allowed in XHR"));
            }
          ...
          setRequestHeader(name, value) {
            ...
            if (this._restrictedHeaders[loweredName] || /^sec\-/.test(loweredName) || /^proxy-/.test(loweredName)) {
              console.warn('Refused to set unsafe header "'.concat(name, '"'));
              return void 0;
            }
          ...
          send(data) {
            ...
            switch (this._url.protocol) {
              ...
              case "https:":
                ...
                break;
              default:
                throw new NetworkError("Unsupported protocol ".concat(this._url.protocol));
            }
            return void 0;
          }
          ...
          getAllResponseHeaders() {
            ...
            lines = (function() {
              ...
              for (name in ref) {
                value = ref[name];
                results.push("".concat(name, ": ").concat(value));
              }
              return results;
            }).call(this);
            return lines.join("\r\n");
          ...
          _sendHttp(data) {
            ...
            if (data != null && (this._method === "GET" || this._method === "HEAD")) {
              console.warn("Discarding entity body for ".concat(this._method, " requests"));
              data = null;
            } else {
              data || (data = "");
            }
          ...
          _parseUrl(urlString) {
            ...
            if (user || password) {
              xhrUrl.auth = "".concat(user, ":").concat(password);
            }
            return xhrUrl;
          }
        ...
        XMLHttpRequest2.prototype._userAgent = "Mozilla/5.0 (".concat(os.type(), " ").concat(os.arch(), ") ") + "node.js/".concat(process.versions.node, " v8/").concat(process.versions.v8);
      ...
      XMLHttpRequestUpload = class XMLHttpRequestUpload extends XMLHttpRequestEventTarget {
        ...
        _setData(data) {
          ...
          if (typeof data === "string") {
            ...
            throw new Error("Unsupported send() data ".concat(data));
          }
          return void 0;
        }
...
//# sourceMappingURL=xhr2-L4RCRBO5.js.map
